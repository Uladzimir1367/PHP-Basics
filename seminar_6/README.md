...
<image src="img/Запуск приложения.png" alt="wind">

Приложение доступно в консоли

<image src="img/Приложение вызов и чтение файла.png" alt="wind">

Работа с приложением пользователя

<image src="img/Работа с приложением.png" alt="wind">

Приложение трребует доработки. Не все команды выполняются корректно.